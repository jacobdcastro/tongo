...
const Legal = (): JSX.Element => {
  return (
    <LegalPrint>
      <h1>Tongo Legal Print</h1>
      <h2>Privacy Policy</h2>
      <p>
        Your privacy is important to us. It is Tongo Inc.'s policy to respect
        your privacy regarding any information we may collect from you across
        our website, <a href="http://www.tongo.app">http://www.tongo.app</a>,
      ...
      <p>
        <strong>Tongo Inc. Data Controller</strong>
        <br />
        Michael Gahan
        <br />
        michael@letstongo.com
      </p>
